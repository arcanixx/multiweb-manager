...
// VERSION: 0.0.3
// PURPOSE: Hook do tasksStore – pobieranie, dodawanie, aktualizacja, usuwanie
//          - load()        pobiera wszystkie taski (tasks:getAll)
//          - add(task)     dodaje task (tasks:add)
//          - update(id, patch) aktualizuje task (tasks:update)
//          - remove(id)    usuwa task (tasks:delete)
// =============================================================================
