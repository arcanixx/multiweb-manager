...
// VERSION: 0.0.3
// PURPOSE: Hook do settingsStore – pobieranie i zapisywanie ustawień
//          - load() pobiera ustawienia przez IPC (settings:get)
//          - save(patch) wysyła patch przez IPC (settings:update) i odświeża stan
// =============================================================================
